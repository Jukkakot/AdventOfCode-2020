...
for (p of p1Valids) {
    ...
    for (field of p) {
        ...
        switch (field[0]) {
            ...
            case "hgt":
                ...
                if (unit) {
                    if (unit === "cm") {
                        if (!(Number(number) >= 150 && Number(number) <= 193)){
                            isValid = false
                            break;
                        }
                    } else if (unit === "in") {
                        if (!(Number(number) >= 59 && Number(number) <= 76)){
                            isValid = false
                            break;
                        }
                    } else {
            ...
            case "pid":
                ...
                break;
            default:
            //  console.log("Ei pitäs mennä mutta okei?")
        }
        if (!isValid) {
            break
        }
    ...
    if (isValid) {
        // console.log("validi passport:",p)
        p2Valids.push(p)
    }
}
console.log("part1 Valid count:", p1Valids.length)
console.log("part2 Valid count:", p2Valids.length)
